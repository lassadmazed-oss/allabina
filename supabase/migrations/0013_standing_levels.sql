...
-- ---------- تصحيح بذرة B05 ----------
-- في البذرة الأولى نزل «الفرش والتغطية» في B05 (170 د/م²) تحت B04 (178):
-- مستوى أعلى بإنفاق أقلّ على نفس اللوط — خطأ في التوزيع لا اختيار.
-- التصحيح يمسّ السطور التي ما زالت تحمل القيمة القديمة وحدها، حتى لا
-- يُمحى تعديل أدخلته الإدارة من الـBack-office.
with fix(lot_code, old_pct, new_pct) as (
  values (3, 5.000, 4.900), (4, 13.600, 13.400), (5, 7.600, 7.500),
         (6, 5.600, 5.400), (7, 3.200, 3.100), (8, 5.200, 5.000),
         (9, 5.600, 5.400), (10, 8.500, 9.800), (11, 6.600, 6.900),
         (12, 5.000, 4.800), (13, 3.200, 3.100), (14, 4.600, 4.400),
         (15, 5.000, 5.600), (16, 2.900, 2.800), (17, 3.900, 3.800),
         (18, 4.400, 4.200), (19, 4.600, 4.400)
)
update standing_lot_shares s
   set share_pct = f.new_pct
  from fix f
