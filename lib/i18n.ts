...
const ar = {
    ...
    form: {
        ...
        apartmentStateLabels: { ready: 'جاهزة', off_plan: 'في طور البناء' } as Record<string, string>,
        apartmentStateHints: { ready: 'مبنية وتنجّم تسكنها.', off_plan: 'تشريها على المخطّط وتختار تشطيبك.' } as Record<string, string>,
        floorPref: 'الطابق',
        floorLabels: { ground: 'أرضي', upper: 'علوي', any: 'ما يهمّش' } as Record<string, string>,
        elevatorNeeded: 'يلزمني مصعد',
        parkingNeeded: 'يلزمني موقف سيارة',
        disabilityGround: 'ذكرت وضعية إعاقة في العائلة — نقترح طابقاً أرضياً أو عمارة بمصعد.',
        disabilityElevator: 'ذكرت وضعية إعاقة في العائلة — فكّر في طابق أرضي كامل أو مصعد.',
        ...
        renterStop: 'الكاري ما ينجّمش يرمّم دار موش ملكو — المالك هو اللي يقرّر. إذا مشكلك في السكن اللي إنت فيه، اختار «مشكل سكني آخر» ونسمعوك.',
        ...
        financeOptionalTitle: 'تحبّ تزيد معطيات مالية؟',
        financeOptionalLede: 'اختياري. تعاون الفريق يفهم وضعك أكثر — وتنجّم تتعدّاها.',
        financeOptionalOpen: 'نزيد المعطيات',
        ...
        housingLabels: {
            ...
            temporary: 'سكن مؤقّت ولا عند ناس',
            homeless: 'بلا مسكن',
            other: 'وضعية أخرى'
        },
