...
/**
 * خطوة كلّ حقل في استمارة المطلب — للافتة الخطأ: تقول أين المشكل وترجع إليه.
 *
 * حقل بلا خطوة كان يُنسب إلى الأخيرة (الاتّصال)، فيُبلَّغ الحريف عن «معطيات
 * الاتّصال» والمشكل في مكان آخر. الاختبار يضمن أنّ كلّ حقل في المخطّط هنا.
 */
